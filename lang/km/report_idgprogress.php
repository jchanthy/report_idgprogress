...
$string['api_service_desc'] = 'សេវា Web Services API សម្រាប់ប្រព័ន្ធខាងក្រៅក្នុងការទាញយកទិន្នន័យវឌ្ឍនភាពវគ្គសិក្សា និងការបញ្ចប់សកម្មភាពរបស់សិក្ខាកាម។';
$string['api_get_course_progress'] = 'ទាញយកទិន្នន័យវឌ្ឍនភាពវគ្គសិក្សា និងព័ត៌មានសិក្ខាកាម';
$string['api_get_user_progress'] = 'ទាញយកព័ត៌មានលម្អិតអំពីវឌ្ឍនភាព និងការបញ្ចប់សកម្មភាពរបស់សិស្សម្នាក់ៗ';
